...
% \colorlet{name}{black}
\colorlet{tagline}{BrandeisBlue}{HTML}{00bfff}
\colorlet{heading}{DeepSkyBlue}
\colorlet{headingrule}{DeepSkyBlue}
...
\begin{document}
\name{Akira Iwasaki}
\tagline{Businessman  \& Analytics Engineer}
...
%   \phone{000-00-0000}
  \mailaddress{info@datamarket.co.jp, Yokohama, Kanagawa Japan}
  \location{Yokohama, JA}
  \homepage{datamarket.co.jp}
  \twitter{@sista05}
  \linkedin{datamarket}
